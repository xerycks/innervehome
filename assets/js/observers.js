...
class App {
  constructor() {
    this.config = {
      ...
      colorSchema: ["#caffe6", "#9bd1e5", "#8774ab", "#4b2665", "#9495d4"],
      numOfLayers: 9,
    };
  ...
  setUpVars() {
    this.canvas.width = this.shadowCanvas.width = this.wWidth =
      window.innerWidth;
    this.canvas.height = this.shadowCanvas.height = this.wHeight =
      window.innerHeight;
